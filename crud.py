...
# Set entries in inputs container
    ...
    style = f" .pages_{bp} > form > #input{bk_input.id}{{top:{db_srcpos.x1}px;left:{db_srcpos.y1}px;width:{(int)width}px;border:2px solid red !important; outline: 2px solid khaki;}}"
